...
import { ArrowRight, ShieldCheck, TrendingUp, AlertTriangle, PlayCircle } from 'lucide-react';
...
export const PlanGenerator: React.FC<Props> = ({ settings, onStartTrading }) => {
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 rounded-xl border-t border-neon-blue/30 animate-float">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          ...
          {onStartTrading && (
            <button 
              ...
              className="btn-shine flex items-center gap-2 bg-neon-blue text-black px-6 py-3 rounded-lg font-bold hover:bg-cyan-400 transition-all shadow-[0_0_20px_rgba(0,243,255,0.4)]"
            >
              Start Live Trading <PlayCircle size={20} />
            </button>
          )}
        </div>
